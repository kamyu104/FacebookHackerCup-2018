...
|5| [City Lights](https://www.facebook.com/hackercup/problem/162710881087828/)| [PyPy](./Final%20Round/city_lights.py) [PyPy](./Final%20Round/city_lights2.py) | _O(S * W^3)_ | _O(S * W^2)_ | Hard | | Skip List, Binary Search, Recursion, Prefix Sum, DP |
